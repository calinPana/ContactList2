...
//try readFile(Contacts.txt);
        ...
        try (BufferedReader in = new BufferedReader(new FileReader("C:\\Users\\test\\Jademy\\ContactList\\Contacts.txt" ))) {
            String sCurrentLine = "";
...
//    }
    ...
    public static void readFile(File file) throws IOException {
        ...
        public static void writeFile (Map < String, Contact > contacts) throws IOException {
            PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("C:\\Users\\test\\Jademy\\ContactList\\ContactsOut.txt" )));
